...
public class AuthorityServiceTest {
	...
	public void findById_idExists_returnsAuthority() {
		...
		when(authorityRepository.findById(authority.getAuthority_id()))
				.thenReturn(Optional.of(authority));
		
		assertThat(authorityService.getById(authority.getAuthority_id()))
			.isPresent()
			.contains(authority);
	}
	...
	public void findById_idDoesNotExist_returnsNothing() {
		assertThat(authorityService.getById(223L))
				.isEmpty();
	}
